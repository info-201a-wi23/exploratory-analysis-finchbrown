...
We found this dataset on the Seattle Open Data Portal. The City of Seattle collected this data as a part of the Seattle Votes campaign, by surveying thousands of immigrants and refugees to learn more about things that hold then back from being able to vote. Seattle Votes is a project run by the Office of Immigrant and Refugee Affairs (OIRA). This dataset has 5,229 observations and 59 features, and it is important to note that the data was not obtained through a random sample.
